      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <AnimatedSection>
          <div className="text-center max-w-3xl mx-auto">
            {/* Trust Badge */}
            <div className="mb-6 md:mb-7 inline-flex items-center gap-2.5 px-4 py-2 rounded-full bg-emerald-50 dark:bg-emerald-900/20 border border-emerald-200/50 dark:border-emerald-800/30">
          ...
          {isOfferActive && (
              <div className="mt-5 md:mt-7 max-w-xl mx-auto bg-white dark:bg-slate-800 rounded-xl p-3 flex flex-col sm:flex-row items-center justify-center gap-3 shadow-sm border border-slate-200/60 dark:border-slate-700/50">
               ...
               <div className="space-y-3">
                  {faqItems.map((item) => (
                    <details key={item.question} className="group bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 overflow-hidden">
                        ...
                        <div className="px-4 md:px-5 pb-4 md:pb-5 pt-2 text-slate-600 dark:text-slate-400 text-sm border-t border-slate-100 dark:border-slate-700 ml-8 leading-relaxed">
                            {item.answer}
                        </div>
                    </details>
                  ))}
