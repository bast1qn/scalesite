...
export const PricingSection: React.FC<PricingSectionProps> = ({ setCurrentPage }) => {
  ...
  const pricingPackages = useMemo(() => {
    const defaults = [
        { id: 1, name: "Starter", price: formatPrice(99), price_details: t('pricing.one_time'), description: t('pricing.packages.starter.desc'), features: [t('pricing_features.pages_up_to_5'), t('pricing_features.responsive_design'), t('pricing_features.contact_form'), t('pricing_features.legal_imprint'), t('pricing_features.basic_seo')], popular: false, with_hosting: false, basePrice: 99 },
        { id: 2, name: "Business", price: formatPrice(199), price_details: t('pricing.one_time'), description: t('pricing.packages.business.desc'), features: [t('pricing_features.pages_up_to_12'), t('pricing_features.cms'), t('pricing_features.blog_section'), t('pricing_features.extended_seo'), t('pricing_features.ai_preparation'), t('pricing_features.conversion_setup')], popular: true, with_hosting: false, basePrice: 199 },
        { id: 3, name: "Enterprise", price: t('pricing.individual'), price_details: t('pricing.by_effort'), description: t('pricing.packages.enterprise.desc'), features: [t('pricing_features.unlimited_pages'), t('pricing_features.custom_react'), t('pricing_features.ai_integration'), t('pricing_features.api_integration'), t('pricing_features.multilingual'), t('pricing_features.priority_support')], popular: false, with_hosting: false, basePrice: 0 },
        { id: 4, name: "Starter+", price: formatPrice(19), price_details: t('pricing.per_month'), description: t('pricing.packages.starter_plus.desc'), features: [t('pricing_features.high_speed_hosting'), t('pricing_features.daily_backups'), t('pricing_features.ssl_certificate'), t('pricing_features.software_updates'), t('pricing_features.email_support')], popular: false, with_hosting: true, basePrice: 19 },
        { id: 5, name: "Business+", price: formatPrice(39), price_details: t('pricing.per_month'), description: t('pricing.packages.business_plus.desc'), features: [t('pricing_features.high_speed_hosting'), t('pricing_features.daily_backups'), t('pricing_features.one_hour_dev'), t('pricing_features.monthly_seo_report'), t('pricing_features.priority_support')], popular: true, with_hosting: true, basePrice: 39 },
        { id: 6, name: "Enterprise+", price: t('pricing.individual'), price_details: t('pricing.per_month'), description: t('pricing.packages.enterprise_plus.desc'), features: [t('pricing_features.dedicated_server'), t('pricing_features.monitoring_24_7'), t('pricing_features.sla_agreement'), t('pricing_features.ai_maintenance'), t('pricing_features.quarterly_meeting')], popular: false, with_hosting: true, basePrice: 0 },
    ];
