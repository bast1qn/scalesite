  ...
  return (
    <footer className="relative bg-slate-50 dark:bg-slate-950 pt-20 pb-10 border-t border-slate-200 dark:border-slate-800 overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-40 dark:opacity-20 pointer-events-none">
        <div className="absolute bottom-0 left-1/4 w-96 h-96 bg-gradient-to-br from-blue-400/15 to-violet-400/15 rounded-full blur-3xl animate-pulse"></div>
        <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-gradient-to-br from-violet-400/15 to-indigo-400/15 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '2s' }}></div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-8 mb-16">
            ...
            <div className="lg:col-span-4 pr-8">
                ...
                <div className="flex gap-3">
                     <a href="https://www.instagram.com/scalesite_app" target="_blank" rel="noopener noreferrer" className="w-10 h-10 flex items-center justify-center border border-slate-200 dark:border-slate-700 rounded-xl hover:bg-gradient-to-br hover:from-purple-500 hover:via-pink-500 hover:to-orange-500 hover:border-transparent hover:text-white hover:shadow-lg hover:shadow-purple-500/25 transition-all duration-300 dark:text-slate-400 hover:scale-110">
                        <span className="sr-only">Instagram</span>
                        <InstagramIcon />
                     </a>
                     <a href="https://discord.gg/65a4PygTJ3" target="_blank" rel="noopener noreferrer" className="w-10 h-10 flex items-center justify-center border border-slate-200 dark:border-slate-700 rounded-xl hover:bg-[#5865F2] hover:border-[#5865F2] hover:text-white hover:shadow-lg hover:shadow-indigo-500/25 transition-all duration-300 dark:text-slate-400 hover:scale-110">
                        <span className="sr-only">Discord</span>
                        <DiscordIcon />
                     </a>
                     <a href="#" className="w-10 h-10 flex items-center justify-center border border-slate-200 dark:border-slate-700 rounded-xl hover:bg-gradient-to-br hover:from-blue-600 hover:to-violet-600 hover:border-transparent hover:text-white hover:shadow-lg hover:shadow-blue-500/25 transition-all duration-300 dark:text-slate-400 hover:scale-110">
                        <span className="sr-only">LinkedIn</span>
                        <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/></svg>
                     </a>
                     <a href="#" className="w-10 h-10 flex items-center justify-center border border-slate-200 dark:border-slate-700 rounded-xl hover:bg-slate-900 dark:hover:bg-white hover:border-slate-900 hover:text-white dark:hover:text-slate-900 hover:shadow-lg hover:shadow-slate-900/25 transition-all duration-300 dark:text-slate-400 hover:scale-110">
        ...
        <div className="pt-8 border-t border-slate-200 dark:border-slate-800 flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-slate-500 dark:text-slate-400 text-xs">&copy; {new Date().getFullYear()} ScaleSite. {t('footer.rights')}</p>
             <div className="flex items-center gap-2 text-slate-500 dark:text-slate-400 text-xs px-4 py-2 rounded-full bg-slate-100 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700">
                <span>{t('footer.built_with')}</span>
                <ReactIcon className="w-3.5 h-3.5 text-blue-500" />
