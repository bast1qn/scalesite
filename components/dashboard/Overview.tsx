                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    <div>
                        <h1 className="text-2xl sm:text-3xl font-bold">
                            Willkommen zurück, <span className="font-medium">{user?.name ? user.name.split(' ')[0] : 'Nutzer'}</span>
                        </h1>
                        <p className="text-white/80 mt-1">Hier ist Ihr Überblick</p>
                    </div>
                ...
                <div className="lg:col-span-2 space-y-6">
                    ...
                    <div className="bg-white dark:bg-slate-900 p-6 rounded-xl border border-slate-200 dark:border-slate-800">
                        <div className="flex items-center justify-between mb-4">
                             <h2 className="text-lg font-semibold text-slate-900 dark:text-white">Aktuelle Projekte</h2>
                        ...
                        <div className="space-y-3">
                            {loading ? (
                                ...
                                <div className="text-center py-8 bg-slate-50 dark:bg-slate-900/50 rounded-lg border border-dashed border-slate-200 dark:border-slate-800">
                                    <p className="text-slate-500 dark:text-slate-400 mb-3">Keine aktiven Projekte.</p>
