...
const features = [
    {
        ...
        bgGradient: 'from-primary-50 to-primary-50 dark:from-primary-900/30 dark:to-primary-900/30',
        glow: 'shadow-primary-500/30',
        borderColor: 'hover:border-primary-200 dark:hover:border-primary-800',
        hexFrom: '#4b5aed',
        hexTo: '#7c8ff8',
    },
    {
    ...
    },
    {
        ...
        bgGradient: 'from-violet-50 to-violet-50 dark:from-violet-900/30 dark:to-violet-900/30',
