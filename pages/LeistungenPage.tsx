                                ...
                                <ul className="space-y-3">
                                    {[
                                        ...
                                        <li key={item.id} className="flex items-center gap-3 text-slate-700 dark:text-slate-300 group">
                                            <div className="w-5 h-5 rounded-md bg-gradient-to-br from-primary-500 to-violet-500 flex items-center justify-center flex-shrink-0 shadow-sm group-hover:scale-[1.02] transition-transform duration-300">
